...
export class DexV2 {
  ...
  async createPoolTx({
    ...
    return this.lucid
      ...
      .pay.ToContract(
        ...
        {
          kind : "inline" , value : Data.to(PoolV2.Datum.toPlutusData(poolDatum)),
        },
        poolValue
      )
      .pay.ToContract(
        ...
        {
          kind : "inline" , value : Data.to(FactoryV2.Datum.toPlutusData(newFactoryDatum1)),
        },
        {
      ...
      .pay.ToContract(
        config.factoryAddress,
        {
          kind : "inline" , value : Data.to(FactoryV2.Datum.toPlutusData(newFactoryDatum2)),
        },
        {
          [config.factoryAsset]: 1n,
        }
  ...
  async createBulkOrdersTx({
    ...
    const limitOrderMessage = limitOrders.length > 0 ? limitOrders : [];
